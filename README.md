...
The function responds to webhooks from Kentico Cloud and then notifies [search service](https://github.com/Kentico/kentico-cloud-docs-search) and [API reference service](https://github.com/Kentico/kentico-cloud-docs-api-refs) about changes in content.

## Overview
1. The function is written in JavaScript and works as an Azure function that is deployed on Azure as well.
